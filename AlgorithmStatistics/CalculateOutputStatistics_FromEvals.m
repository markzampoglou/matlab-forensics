...
rng('shuffle');
Algorithms={'01' '02' '04' '05' '06' '07' '08' '10' '12' '14' '16a' '16b' '17' '18'};
...
for AlgInd=1:length(Algorithms)
    ...
    disp(Algorithm)
    AllEvals=getAllFiles([InputRoot '/' Algorithm '/'],'*.mat',true);
    for EvalInd=1:length(AllEvals)
        load(AllEvals{EvalInd});
        MedianDiffs=cell2mat({Results.MaskMedian}-{Results.OutsideMedian});
    end
