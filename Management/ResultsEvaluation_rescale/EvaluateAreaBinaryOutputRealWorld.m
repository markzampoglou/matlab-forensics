clear all;
MaskLimits=[-5.6088 3.5735];%[0 0.7; 0 1; 0 22; 0 700; 0 0.1];
...
AlgorithmNames={'17'}  % '12'  '16' '01' '04' '05' '06' '07' 
...
Folders=dir([ImageRoot Datasets.MarkRealWorldSplices]);
...
for AlgorithmInd=1:length(AlgorithmNames)
    ...
    for Folder=1:length(Folders)
        ...
        disp(InputFolder)
        InputPath=[InputRoot AlgorithmName '/' Datasets.MarkRealWorldSplices '/' InputFolder];
        MaskPath=[ImageRoot Datasets.MarkRealWorldSplices '/' InputFolder '/Mask/'];
