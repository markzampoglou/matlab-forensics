clear all;
AlgorithmNames={'17'}; %{'01' '02' '04' '05' '07' '10' '14' '16' };% '12' '08' {'01' '02' '04' '05' '07' '08' '10' '14' '16' }; % '12'  '16'
...
Folders=dir([ImageRoot '/WildWebDataset/WildWeb/']);
...
for AlgorithmInd=1:length(AlgorithmNames)
    ...
    for Folder=1:length(Folders)
        ...
        InputPath=[InputRoot AlgorithmName '/WildWebDataset/WildWeb/' InputFolder];
        MaskPath=[ImageRoot '/WildWebDataset/WildWeb/' Folders(Folder).name '/Mask/'];
